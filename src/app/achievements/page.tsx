...
const achievementsData = {
  earnedBadges: [
    ...
    },
    {
      ...
      icon: Users,
      color: "text-slate-400",
      description: "Posted 10 helpful replies in the forum."
    },
    {
      name: "Eco Farmer",
      level: "Bronze",
    ...
    },
     {
      ...
      icon: Zap,
      color: "text-yellow-500",
      description: "Planted recommended crops during the spring season."
    },
  ],
  inProgress: [
    {
      name: "Eco Farmer - Silver",
      progress: 78,
      goal: 80,
      description: "Achieve a sustainability score of 80 for the Silver badge."
    },
    {
      name: "Disease Detective - Gold",
      progress: 12,
      goal: 25,
      description: "Identify 13 more diseases to unlock the Gold badge."
    },
     {
      name: "Community Helper - Gold",
      progress: 11,
      goal: 25,
  ...
  leaderboard: [
    { rank: 1, name: "Priya Singh", score: 95, avatar: "https://picsum.photos/seed/priya/100/100" },
    { rank: 2, name: "Rohan Singh", score: 92, avatar: "https://picsum.photos/seed/rohan/100/100" },
    { rank: 3, name: "Sanjay Kumar", score: 88, avatar: "https://picsum.photos/seed/sanjay/100/100" },
    { rank: 4, name: "Rina Devi", score: 85, avatar: "https://picsum.photos/seed/rina/100/100" },
    { rank: 5, name: "Amit Patel", score: 81, avatar: "https://picsum.photos/seed/amit/100/100" },
  ]
};
